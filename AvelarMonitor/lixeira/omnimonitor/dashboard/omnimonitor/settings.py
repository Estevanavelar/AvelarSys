"""
Django settings for OmniMonitor Dashboard
"""
...
WSGI_APPLICATION = 'omnimonitor.wsgi.application'
ASGI_APPLICATION = 'omnimonitor.asgi.application'
...
METRICS_DOWNSAMPLE_ENABLED = config('METRICS_DOWNSAMPLE_ENABLED', default=True, cast=bool)

ALERT_CHECK_INTERVAL = config('ALERT_CHECK_INTERVAL', default=60, cast=int)
